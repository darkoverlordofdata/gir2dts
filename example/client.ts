...
let s = new Serve("/home/bruce/Git/spaceship-warrior-ts/web")
...
// webView.load_uri(url(argv.filter(url => '-' !== url[0])[0] || 'darkoverlordofdata.com'))
webView.load_uri(url(argv.filter(url => '-' !== url[0])[0] || 'http:0.0.0.0:8088/index.html'))
