...
declare module 'GObject' {
  ...
  export function cclosure_marshal_BOOLEAN__BOXED_BOXED(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_BOOLEAN__FLAGS(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_STRING__OBJECT_POINTER(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__BOOLEAN(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__BOXED(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__CHAR(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__DOUBLE(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__ENUM(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__FLAGS(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__FLOAT(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__INT(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__LONG(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__OBJECT(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__PARAM(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__POINTER(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__STRING(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__UCHAR(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__UINT(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__UINT_POINTER(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__ULONG(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__VARIANT(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_VOID__VOID(closure: any, return_value: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_marshal_generic(closure: any, return_gvalue: any, n_param_values: number, param_values: any, invocation_hint: object, marshal_data: object):void
  export function cclosure_new(callback_func: any, user_data: object, destroy_data: any):any
  ...
  export function cclosure_new_swap(callback_func: any, user_data: object, destroy_data: any):any
  ...
  export function signal_accumulator_first_wins(ihint: any, return_accu: any, handler_return: any, dummy: object):boolean
  export function signal_accumulator_true_handled(ihint: any, return_accu: any, handler_return: any, dummy: object):boolean
  export function signal_add_emission_hook(signal_id: number, detail: any, hook_func: any, hook_data: object, data_destroy: any):number
  ...
  export function signal_connect_data(instance: Object, detailed_signal: string, c_handler: any, data: object, destroy_data: any, connect_flags: ConnectFlags):number
  export function signal_connect_object(instance: object, detailed_signal: string, c_handler: any, gobject: object, connect_flags: ConnectFlags):number
  ...
  export function signal_emit_valist(instance: object, signal_id: number, detail: any, var_args: any):void
  ...
  export function signal_handler_find(instance: Object, mask: SignalMatchType, signal_id: number, detail: any, closure: any, func: object, data: object):number
  ...
  export function signal_handlers_block_matched(instance: Object, mask: SignalMatchType, signal_id: number, detail: any, closure: any, func: object, data: object):number
  export function signal_handlers_destroy(instance: Object):void
  export function signal_handlers_disconnect_matched(instance: Object, mask: SignalMatchType, signal_id: number, detail: any, closure: any, func: object, data: object):number
  export function signal_handlers_unblock_matched(instance: Object, mask: SignalMatchType, signal_id: number, detail: any, closure: any, func: object, data: object):number
  ...
  export function signal_new(signal_name: string, itype: any, signal_flags: SignalFlags, class_offset: number, accumulator: any, accu_data: object, c_marshaller: any, return_type: any, n_params: number, ...args: any):number
  export function signal_new_class_handler(signal_name: string, itype: any, signal_flags: SignalFlags, class_handler: any, accumulator: any, accu_data: object, c_marshaller: any, return_type: any, n_params: number, ...args: any):number
  export function signal_new_valist(signal_name: string, itype: any, signal_flags: SignalFlags, class_closure: any, accumulator: any, accu_data: object, c_marshaller: any, return_type: any, n_params: number, args: any):number
  export function signal_newv(signal_name: string, itype: any, signal_flags: SignalFlags, class_closure: any, accumulator: any, accu_data: object, c_marshaller: any, return_type: any, n_params: number, param_types: any[]):number
  ...
  export function type_add_class_cache_func(cache_data: object, cache_func: any):void
  ...
  export function type_add_interface_check(check_data: object, check_func: any):void
  ...
  export function type_get_qdata(type: any, quark: any):object
  ...
  export function type_remove_class_cache_func(cache_data: object, cache_func: any):void
  export function type_remove_interface_check(check_data: object, check_func: any):void
  export function type_set_qdata(type: any, quark: any, data: object):void
  ...
  export class Object {
    constructor(object_type: any, first_property_name: string, var_args: any)
    constructor(object_type: any, n_parameters: number, parameters: any[])
    add_toggle_ref(notify: any, data: object):void
    ...
    bind_property_full(source_property: string, target: Object, target_property: string, flags: BindingFlags, transform_to: any, transform_from: any, user_data: object, notify: any):Binding
    ...
    dup_data(key: string, dup_func: any, user_data: object):object
    dup_qdata(quark: any, dup_func: any, user_data: object):object
    force_floating():void
    freeze_notify():void
    get_data(key: string):object
    get_property(property_name: string, value: any):void
    get_qdata(quark: any):object
    ...
    ref():Object
    ref_sink():Object
    remove_toggle_ref(notify: any, data: object):void
    remove_weak_pointer(weak_pointer_location: object):void
    replace_data(key: string, oldval: object, newval: object, destroy: any, old_destroy: any):boolean
    replace_qdata(quark: any, oldval: object, newval: object, destroy: any, old_destroy: any):boolean
    run_dispose():void
    set_data(key: string, data: object):void
    set_data_full(key: string, data: object, destroy: any):void
    set_property(property_name: string, value: any):void
    set_qdata(quark: any, data: object):void
    set_qdata_full(quark: any, data: object, destroy: any):void
    set_valist(first_property_name: string, var_args: any):void
    steal_data(key: string):object
    steal_qdata(quark: any):object
    thaw_notify():void
    unref():void
    watch_closure(closure: any):void
    weak_ref(notify: any, data: object):void
    weak_unref(notify: any, data: object):void
  }
