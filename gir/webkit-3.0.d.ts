...
declare module 'WebKit' {
  ...
  export class FaviconDatabase extends GObject.Object {
    clear():void
    get_favicon_pixbuf(page_uri: string, width: number, height: number, cancellable: Gio.Cancellable, callback: any, user_data: object):void
  ...
  export class WebResource extends GObject.Object {
    constructor(data: string, size: number, uri: string, mime_type: string, encoding: string, frame_name: string)
    get_data():any
    get_encoding():string
