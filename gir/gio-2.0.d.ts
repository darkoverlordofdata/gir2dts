...
declare module 'Gio' {
    ...
    export function async_initable_newv_async(object_type: any, n_parameters: number, parameters: any, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export function bus_own_name_on_connection(connection: DBusConnection, name: string, flags: BusNameOwnerFlags, name_acquired_handler: any, name_lost_handler: any, user_data: any, user_data_free_func: any):number
    ...
    export function bus_watch_name_on_connection(connection: DBusConnection, name: string, flags: BusNameWatcherFlags, name_appeared_handler: any, name_vanished_handler: any, user_data: any, user_data_free_func: any):number
    ...
    export class DBusConnection extends GObject.Object {
        ...
        call_with_unix_fd_list(bus_name: string, object_path: string, interface_name: string, method_name: string, parameters: any, reply_type: any, flags: DBusCallFlags, timeout_msec: number, fd_list: UnixFDList, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        close(cancellable: Cancellable, callback: any, user_data: any):void
        ...
        flush(cancellable: Cancellable, callback: any, user_data: any):void
        ...
        is_closed():boolean
        register_object(object_path: string, interface_info: any, vtable: any, user_data: any, user_data_free_func: any):number
        ...
        register_subtree(object_path: string, vtable: any, flags: DBusSubtreeFlags, user_data: any, user_data_free_func: any):number
        remove_filter(filter_id: number):void
        send_message(message: DBusMessage, flags: DBusSendMessageFlags, out_serial: number):boolean
        send_message_with_reply(message: DBusMessage, flags: DBusSendMessageFlags, timeout_msec: number, out_serial: number, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        signal_subscribe(sender: string, interface_name: string, member: string, object_path: string, arg0: string, flags: DBusSignalFlags, callback: any, user_data: any, user_data_free_func: any):number
    ...
    export class DBusProxy extends GObject.Object {
        ...
        call_with_unix_fd_list(method_name: string, parameters: any, flags: DBusCallFlags, timeout_msec: number, fd_list: UnixFDList, cancellable: Cancellable, callback: any, user_data: any):void
        call_with_unix_fd_list_finish(out_fd_list: UnixFDList, res: any):any
    ...
    export class DataInputStream extends BufferedInputStream {
        ...
        read_line_async(io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        read_until_async(stop_chars: string, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        read_upto_async(stop_chars: string, stop_chars_len: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class DesktopAppInfo extends GObject.Object {
        ...
        launch_uris_as_manager(uris: any, launch_context: AppLaunchContext, spawn_flags: GLib.SpawnFlags, user_setup: any, user_setup_data: any, pid_callback: any, pid_callback_data: any):boolean
        list_actions():string[]
    }
    ...
    export class FileEnumerator extends GObject.Object {
        ...
        next_files_async(num_files: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class IOStream extends GObject.Object {
        ...
        is_closed():boolean
        set_pending():boolean
        splice_async(stream2: IOStream, flags: IOStreamSpliceFlags, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
    }
    ...
    export class InputStream extends GObject.Object {
        ...
        read_all_async(buffer: number[], count: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        read_all_finish(result: any, bytes_read: number):boolean
        read_async(buffer: number[], count: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        read_bytes(count: number, cancellable: Cancellable):any
        read_bytes_async(count: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        read_bytes_finish(result: any):any
        read_finish(result: any):number
        set_pending():boolean
        skip(count: number, cancellable: Cancellable):number
        skip_async(count: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class ListStore extends GObject.Object {
        ...
        insert_sorted(item: GObject.Object, compare_func: any, user_data: any):number
        remove(position: number):void
        remove_all():void
        sort(compare_func: any, user_data: any):void
    ...
    export class OutputStream extends GObject.Object {
        ...
        flush_async(io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        splice_async(source: InputStream, flags: OutputStreamSpliceFlags, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        write_all_async(buffer: number[], count: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        write_all_finish(result: any, bytes_written: number):boolean
        write_async(buffer: number[], count: number, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
        write_bytes(bytes: any, cancellable: Cancellable):number
        write_bytes_async(bytes: any, io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class Permission extends GObject.Object {
        ...
        release_async(cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class Resolver extends GObject.Object {
        ...
        lookup_by_name_async(hostname: string, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        lookup_records_async(rrname: string, record_type: ResolverRecordType, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        lookup_service_async(service: string, protocol: string, domain: string, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class Settings extends GObject.Object {
        ...
        get_mapped(key: string, mapping: any, user_data: any):any
    ...
    export class SimpleActionGroup extends GObject.Object {
        constructor(config?: any)
        add_entries(entries: any[], n_entries: number, user_data: any):void
    ...
    export class SimpleAsyncResult extends GObject.Object {
        ...
        set_op_res_gpointer(op_res: any, destroy_op_res: any):void
    ...
    export class SocketClient extends GObject.Object {
        ...
        connect_async(connectable: any, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        connect_to_host_async(host_and_port: string, default_port: number, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        connect_to_service_async(domain: string, service: string, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        connect_to_uri_async(uri: string, default_port: number, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class SocketListener extends GObject.Object {
        ...
        accept_async(cancellable: Cancellable, callback: any, user_data: any):void
        ...
        accept_socket_async(cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class Subprocess extends GObject.Object {
        ...
        communicate_utf8_async(stdin_buf: string, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        wait_async(cancellable: Cancellable, callback: any, user_data: any):void
        wait_check(cancellable: Cancellable):boolean
        wait_check_async(cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class SubprocessLauncher extends GObject.Object {
        ...
        set_child_setup(child_setup: any, user_data: any, destroy_notify: any):void
    ...
    export class Task extends GObject.Object {
        ...
        return_pointer(result: any, result_destroy: any):void
    ...
    export class TlsConnection extends IOStream {
        ...
        handshake_async(io_priority: number, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class TlsDatabase extends GObject.Object {
        ...
        lookup_certificate_issuer_async(certificate: TlsCertificate, interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        lookup_certificates_issued_by_async(issuer_raw_dn: number[], interaction: TlsInteraction, flags: TlsDatabaseLookupFlags, cancellable: Cancellable, callback: any, user_data: any):void
        ...
        verify_chain_async(chain: TlsCertificate, purpose: string, identity: any, interaction: TlsInteraction, flags: TlsDatabaseVerifyFlags, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class TlsInteraction extends GObject.Object {
        ...
        request_certificate_async(connection: TlsConnection, flags: TlsCertificateRequestFlags, cancellable: Cancellable, callback: any, user_data: any):void
    ...
    export class UnixConnection extends SocketConnection {
        ...
        send_credentials_async(cancellable: Cancellable, callback: any, user_data: any):void
