...
declare module 'GLib' {
  ...
  export function child_watch_add(pid: any, function_: any, data: object):number
  export function child_watch_add_full(priority: number, pid: any, function_: any, data: object, notify: any):number
  export function child_watch_source_new(pid: any):any
  export function clear_error():void
  export function clear_pointer(pp: object, destroy: any):void
  ...
  export function datalist_foreach(datalist: any, func: any, user_data: object):void
  export function datalist_get_data(datalist: any, key: string):object
  export function datalist_get_flags(datalist: any):number
  export function datalist_id_dup_data(datalist: any, key_id: any, dup_func: any, user_data: object):object
  export function datalist_id_get_data(datalist: any, key_id: any):object
  export function datalist_id_remove_no_notify(datalist: any, key_id: any):object
  export function datalist_id_replace_data(datalist: any, key_id: any, oldval: object, newval: object, destroy: any, old_destroy: any):boolean
  export function datalist_id_set_data_full(datalist: any, key_id: any, data: object, destroy_func: any):void
  ...
  export function dataset_foreach(dataset_location: object, func: any, user_data: object):void
  export function dataset_id_get_data(dataset_location: object, key_id: any):object
  export function dataset_id_remove_no_notify(dataset_location: object, key_id: any):object
  export function dataset_id_set_data_full(dataset_location: object, key_id: any, data: object, destroy_func: any):void
  ...
  export function hash_table_add(hash_table: any, key: object):boolean
  export function hash_table_contains(hash_table: any, key: object):boolean
  export function hash_table_destroy(hash_table: any):void
  export function hash_table_insert(hash_table: any, key: object, value: object):boolean
  export function hash_table_lookup_extended(hash_table: any, lookup_key: object, orig_key: object, value: object):boolean
  export function hash_table_remove(hash_table: any, key: object):boolean
  export function hash_table_remove_all(hash_table: any):void
  export function hash_table_replace(hash_table: any, key: object, value: object):boolean
  export function hash_table_size(hash_table: any):number
  export function hash_table_steal(hash_table: any, key: object):boolean
  ...
  export function idle_add(function_: any, data: object):number
  export function idle_add_full(priority: number, function_: any, data: object, notify: any):number
  ...
  export function io_add_watch(channel: any, condition: IOCondition, func: any, user_data: object):number
  export function io_add_watch_full(channel: any, priority: number, condition: IOCondition, func: any, user_data: object, notify: any):number
  ...
  export function log_set_default_handler(log_func: any, user_data: object):any
  export function log_set_fatal_mask(log_domain: string, fatal_mask: LogLevelFlags):LogLevelFlags
  export function log_set_handler(log_domain: string, log_levels: LogLevelFlags, log_func: any, user_data: object):number
  export function log_set_handler_full(log_domain: string, log_levels: LogLevelFlags, log_func: any, user_data: object, destroy: any):number
  ...
  export function qsort_with_data(pbase: object, total_elems: number, size: number, compare_func: any, user_data: object):void
  ...
  export function sequence_set(iter: any, data: object):void
  ...
  export function source_remove_by_funcs_user_data(funcs: any, user_data: object):boolean
  ...
  export function spawn_async(working_directory: string, argv: string[], envp: string[], flags: SpawnFlags, child_setup: any, user_data: object, child_pid: any):boolean
  export function spawn_async_with_pipes(working_directory: string, argv: string[], envp: string[], flags: SpawnFlags, child_setup: any, user_data: object, child_pid: any, standard_input: number, standard_output: number, standard_error: number):boolean
  ...
  export function spawn_sync(working_directory: string, argv: string[], envp: string[], flags: SpawnFlags, child_setup: any, user_data: object, standard_output: number[], standard_error: number[], exit_status: number):boolean
  ...
  export function test_add_data_func(testpath: string, test_data: object, test_func: any):void
  export function test_add_data_func_full(testpath: string, test_data: object, test_func: any, data_free_func: any):void
  export function test_add_func(testpath: string, test_func: any):void
  export function test_add_vtable(testpath: string, data_size: number, test_data: object, data_setup: any, data_test: any, data_teardown: any):void
  ...
  export function test_create_case(test_name: string, data_size: number, test_data: object, data_setup: any, data_test: any, data_teardown: any):any
  ...
  export function test_log_set_fatal_handler(log_func: any, user_data: object):void
  ...
  export function test_queue_destroy(destroy_func: any, destroy_data: object):void
  ...
  export function timeout_add(interval: number, function_: any, data: object):number
  export function timeout_add_full(priority: number, interval: number, function_: any, data: object, notify: any):number
  export function timeout_add_seconds(interval: number, function_: any, data: object):number
  export function timeout_add_seconds_full(priority: number, interval: number, function_: any, data: object, notify: any):number
  ...
  export function trash_stack_push(stack_p: any, data_p: object):void
  ...
  export function unix_fd_add(fd: number, condition: IOCondition, function_: any, user_data: object):number
  export function unix_fd_add_full(priority: number, fd: number, condition: IOCondition, function_: any, user_data: object, notify: any):number
  ...
  export function unix_signal_add(signum: number, handler: any, user_data: object):number
  export function unix_signal_add_full(priority: number, signum: number, handler: any, user_data: object, notify: any):number
