...
declare module 'Gdk' {
  ...
  export function event_handler_set(func: any, data: object, notify: any):void
  ...
  export function threads_add_idle(function_: any, data: object):number
  export function threads_add_idle_full(priority: number, function_: any, data: object, notify: any):number
  export function threads_add_timeout(interval: number, function_: any, data: object):number
  export function threads_add_timeout_full(priority: number, interval: number, function_: any, data: object, notify: any):number
  export function threads_add_timeout_seconds(interval: number, function_: any, data: object):number
  export function threads_add_timeout_seconds_full(priority: number, interval: number, function_: any, data: object, notify: any):number
  ...
  export class Window extends GObject.Object {
    ...
    add_filter(function_: any, data: object):void
    beep():void
    ...
    get_children():any
    get_children_with_user_data(user_data: object):any
    get_clip_region():any
    ...
    invalidate_maybe_recurse(region: any, child_func: any, user_data: object):void
    ...
    raise():void
    register_dnd():void
    remove_filter(function_: any, data: object):void
